...
import LpCardSkeleton from "../features/lp/components/LpCardSkeleton";
import { useLps, useSearchLps } from "../features/lp/hooks/useLps";
...
const HomePage = () => {
  ...
  const searchLps = useSearchLps(order, debounceSearch);
  const {
    data,
    hasNextPage,
    isFetchingNextPage,
